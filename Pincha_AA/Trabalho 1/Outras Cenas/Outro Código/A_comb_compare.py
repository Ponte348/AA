...
# Algoritmo Exaustivo - que vê todas as combinações (Apenas usado para comparação da complexidade computacional)
...
def main():
    ...
    for z in range(len(P_list)):
        ...
        for r in range(len(K)):
            ...
            AE_time = [0 for x in range(len(S))]                           # Tempo Exaustiva ALL COMBINATIONS
            AE_op = [0 for x in range(len(S))]                           # Operações Exaustiva ALL COMBINATIONS
            ...
            for w in range(len(S)):
                ...
                print("\nALL Exaustive Result:",set(S_AE))
                toc = time.perf_counter()
                AE_time[w] = toc-tic
                AE_op[w] = op_ALLexaustive
                print(f"Time: {toc - tic:0.4f} seconds")
                ...
                if len(S_AE) != 0:
                    print("\nExaustiva Set is Dominating?-> ",nX.is_dominating_set(G, set(S_AE)))                    
            ...
            print("\nTimes Exaustiva ALL COMBINATIONS:",AE_time)
            print("Operações Exaustiva ALL COMBINATIONS:", AE_op)

            with open("C:/Users/OMEN/OneDrive - Universidade de Aveiro/Mestrado/4 ano/1 semestre/AA/Trabalho 1/ALL_4_25.txt","a") as f:
                f.write("\n"+"Size ="+str(S)+"; %K ="+str(k)+"; %P ="+str(P)+";")
                f.write("\n"+"Op_Exaustive ="+ str(e_op)+";"+"\n"+"Op_Heuristic ="+ str(h_op)+";"+"\n"+"Op_ALLExaustive ="+ str(AE_op)+";")
                f.write("\n"+"Times_Exaustive ="+ str(e_time)+";"+"\n"+"Times_Heuristic ="+ str(h_time)+";"+"\n"+"Times_ALLExaustive ="+ str(AE_time)+";")
                f.write("\n")
