...
def main():
    ...
    path = 'C:/Users/gfrei/Desktop/Grafo451.txt'

    G, array = create_graph(path)
    #print(nX.dominating_set(G))
    s = 4039
    edges = 88234
    print("\nN vertice:",s) 
    print("\nN edges:",edges,"\nLen array edges:",len(array))
    print("First edge:",array[0]) 
    print("Last edge:",array[-1]) 
    ...
    with open("C:/Users/gfrei/Desktop/BD6_GrafO451.txt","a") as f:
        f.write("\n\n%Todos os parâmetros")
        f.write("\nSize ="+str(s)+";")
        f.write("\n"+"Ks ="+ str(k_tentados)+";")
