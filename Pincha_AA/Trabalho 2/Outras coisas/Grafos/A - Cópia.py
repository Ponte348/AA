...
def make_txt_header():
    with open("C:/Users/OMEN/Desktop/tiny.txt","w") as f:
...
def main():
    ...
    path = 'C:/Users/OMEN/Desktop/SWtinyG.txt'

    G, s = create_graph(path)
    ...
    with open("C:/Users/OMEN/Desktop/tiny.txt","a") as f:
        f.write("\n\n%Todos os parâmetros")
        f.write("\nSize ="+str(s)+";")
        f.write("\n"+"Ks ="+ str(k_tentados)+";")
