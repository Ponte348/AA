...
def make_txt_header():
    with open("C:/Users/OMEN/Desktop/Upgrade.txt","w") as f:
...
def create_Ks(Size, P):

    if P == 0.125:
        corte = math.ceil(Size/10)

        ks = [x for x in range(corte,Size)]
...
def main():
    ...
    for z in range(len(P_list)):
        ...
        with open("C:/Users/OMEN/Desktop/Upgrade.txt","a") as f:
            f.write("\n\n%Todos os parâmetros")
            f.write("\n"+"P ="+str(P)+";"+"\nSize ="+str(S)+";")
            f.write("\n"+"Ks ="+ str(k_vector)+";")
            f.write("\n"+"Operacoes ="+ str(e_op)+";")
