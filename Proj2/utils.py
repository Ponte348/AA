...
def generate_graph_erdos_renyi(nodes, edge_prob):
    """
    Creates a graph using the Erdos-Renyi model.
    Each pair of nodes is connected with probability edge_prob.
    """
    graph = nx.erdos_renyi_graph(nodes, edge_prob, seed=98059)
    return graph
